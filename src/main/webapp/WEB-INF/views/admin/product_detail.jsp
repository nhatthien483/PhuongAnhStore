                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <div class="product-details-action rounded-3 p-3">
                                        <a href="${pageContext.request.contextPath}/admin/productManagement?action=edit&id=${product.productId}" class="btn-product btn-warning "><span>Chỉnh Sửa Sản Phẩm</span></a>
