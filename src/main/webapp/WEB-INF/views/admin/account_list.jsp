...
<html>
            ...
            <div class="container-fluid">
                ...
                <div class="notification-container">
                    <c:if test="${not empty sessionScope.notification}">
                        <div class="alert alert-success" id="notification-alert" role="alert">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="users?action=add" class="btn btn-primary">
                        ...
                        <table class="admin-table">
                            ...
                            <tbody>
                                <c:if test="${empty users}">
                                    <tr>
                                        <td colspan="8">
                                            <div class="alert alert-warning">Không có người dùng nào được tìm thấy</div>
                                        </td>
                                    </tr>
                                </c:if>
    ...
    setTimeout(() => {
        ...
        if (alert) {
            ...
            // Xoá khỏi DOM sau khi hiệu ứng hoàn tất
