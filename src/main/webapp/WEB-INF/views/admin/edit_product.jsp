                ...
                <div class="card-body">
                    <form id="productForm">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="type" class="form-control" rows="1" placeholder="${product.type}"></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="note" class="form-control" rows="1" placeholder="${product.note}"></textarea>
                        </div>
