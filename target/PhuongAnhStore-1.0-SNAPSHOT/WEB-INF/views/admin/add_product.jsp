...
<a href="${pageContext.request.contextPath}/home" class="btn btn-outline-secondary">🏠Trở Về Trang Chủ</a>
                <a href="${pageContext.request.contextPath}/admin/productManagement" class="btn btn-outline-secondary">⬅Trở Về Trang Sản Phẩm</a>
        ...
        <div class="card-body">
            <form id="productForm">
                ...
                <div class="d-flex justify-content-between">
                    <a href="${pageContext.request.contextPath}/admin/productManagement" class="btn btn-secondary">⬅ Quay lại</a>
